...
export function calculatePeriodSummary(
  ...
  return {
    ...
    maxProtein: proteinValues.length > 0 ? Math.max(...proteinValues) : 0,
    minProtein: proteinValues.length > 0 ? Math.min(...proteinValues) : 0,
    proteinGoal,
    proteinGoalAchieved,
    ...
    minCalories: calorieValues.length > 0 ? Math.min(...calorieValues) : 0,
    calorieGoal,
    calorieGoalAchieved,
