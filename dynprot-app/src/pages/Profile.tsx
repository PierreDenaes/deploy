                    ...
                    <CardContent className="p-6 space-y-6">
                      <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                          <h4 className="text-lg font-semibold">Fonctionnalités disponibles</h4>
                          <div className="grid gap-4">
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                  <div className="font-semibold">Recommandations de repas</div>
                                  <div className="text-sm text-muted-foreground">Suggestions personnalisées basées sur vos objectifs</div>
                                </div>
                              </div>
                            </Button>
                            ...
                            >
                              <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                  <div className="font-semibold">Analyse nutritionnelle</div>
                                  <div className="text-sm text-muted-foreground">Insights détaillés sur vos habitudes alimentaires</div>
                                </div>
                              </div>
                            </Button>
                          </div>
